    ...
    URL : (function(){
      ...
      */
        ...
        return {
            ...
            Recommend : _origin + _app + '/recommend',
...
WixU.main = new WixUClass({
    ...
    function : {
        ...
        setEventListener : function(){
            ...
            //recommend (shinzato)
            $('.wix-recommend').on('click',function(){
                //alert('popup');
                var wixRecommendPopup = document.getElementById('wix-recommend-popup');
                var popupStyle = document.defaultView.getComputedStyle(wixRecommendPopup,null).display;
                if (popupStyle == 'none') {
                  ...
                  xhr.open('POST', 'http://trezia.db.ics.keio.ac.jp/shinzato/keitaiso/keyphrase_extraction.php');
                  xhr.setRequestHeader('content-type', 'application/x-www-form-urlencoded;charset=UTF-8');
                  xhr.send('geturl=' + htmlurl);
                  xhr.onreadystatechange = function() {
                    keitaiso_result = xhr.responseText;
                    var xhr2 = new XMLHttpRequest();
                    xhr2.open('POST', Constant.URL.Recommend);
                    xhr2.setRequestHeader('content-type', 'application/x-www-form-urlencoded;charset=UTF-8');
                    xhr2.send('body=' + keitaiso_result);
                    console.log(keitaiso_result)
                    xhr2.onreadystatechange = function() {
                      // console.log( xhr2.responseText );
                      wixRecommendPopup.innerHTML = '<b>Recommended WIX File</b><br>' + xhr2.responseText;
                    }
                  }
                  ...
                  xhr.onreadystatechange = function() {
                    if(xhr.readyState === 4 && xhr.status === 200) {
                      ...
                      wixRecommendPopup.innerHTML = 'recommendContents<br>' + xhr.responseText;
                    }
                  }
                  */
                  //wixRecommendPopup.innerHTML = 'recommendContents<br>' + random + htmldoc;
                  $('#wix-recommend-popup').show();
                } else {
                  $('#wix-recommend-popup').hide();
                }
            })

            /* なぜかここ動かない shinzato
            $('.wix-recommend-popup-close').click(function(){
                $('#wix-recommend-popup').hide();
            })
            */

            //custom (shinzato)
            $('.wix-custom').on('click',function(){
                alert('popup');
                /*var customPopup;
                customPopup = window.open("", "customPopup", "");
                customPopup.document.write("<p>popup</p>");*/
            });
